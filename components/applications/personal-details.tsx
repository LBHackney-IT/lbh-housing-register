    ...
    <Collapsible heading={heading}>
      <dl className="govuk-summary-list lbh-summary-list">
        ...
        <div className="govuk-summary-list__row">
          ...
          <dd className="govuk-summary-list__value">{applicant.person.gender}</dd>
          <span className="govuk-summary-list__actions"></span>
        </div>
        <div className="govuk-summary-list__row">
          <dt className="govuk-summary-list__key">Nationality</dt>
          <dd className="govuk-summary-list__value">{applicant.person.nationality}</dd>
          <span className="govuk-summary-list__actions"></span>
        </div>
        <div className="govuk-summary-list__row">
          <dt className="govuk-summary-list__key">Date of birth</dt>
          <dd className="govuk-summary-list__value">{applicant.person.dateOfBirth}</dd>
          <span className="govuk-summary-list__actions"></span>
        </div>
      </dl>
    </Collapsible>
