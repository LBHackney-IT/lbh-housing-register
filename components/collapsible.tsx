...
export default function Collapsible({ heading, children }: CollapsibleProps): JSX.Element {
  const [open, setOpen] = useState(true);

  return (
    <section className="lbh-collapsible">
      <button aria-expanded={open} className="lbh-collapsible__button" onClick={() => setOpen(!open)}>
