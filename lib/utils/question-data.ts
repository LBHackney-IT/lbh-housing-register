export enum QuestionKey {
  ...
  CURRENT_ACCOMMODATION_HOST_PERSON_NAME = 'current-accommodation/host-person-name',
  CURRENT_ACCOMMODATION_HOST_PERSON_NUMBER = 'current-accommodation/host-person-number',
