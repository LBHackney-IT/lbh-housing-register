    ...
    return (
      <>
        <Layout pageName="Home" pageLoadsApplication={false}>
          ...
          <Paragraph>
            The form could take up to an hour to complete, as we ask for
            personal information about yourself and any other people you want to
            move with.
          </Paragraph>
          <Paragraph>
          ...
          <WarningText>
            ...
            <List>
              ...
              <ListItem bold={true}>
                You are a victim of gang violence{' '}
              </ListItem>
            </List>
            <Paragraph bold={true}>
              ...
              <a
                className="lbh-link"
                href="https://forms.gle/riaWcWbAY1j6uszR7"
              >
                complete this form
              </a>{' '}
          ...
          <Paragraph>
            After completing this form, we may email you links to securely
            provide additional information or documents to support your
            application.
          </Paragraph>
          <Paragraph>
            We will then verify your information to assess your suitability for
            social housing in Hackney. You will receive a decision by email
          ...
          <Announcement variant="info">
            ...
            <Paragraph>
              If you choose to rent privately, we may be able to help in a
              number of ways, both financially and practically.
              <br />
